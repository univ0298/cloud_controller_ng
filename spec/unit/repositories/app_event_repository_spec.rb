    ...
    RSpec.describe AppEventRepository do
      ...
      describe '#record_app_update' do
        ...
        it 'records the expected fields on the event and logs the event' do
          ...
          expect(VCAP::AppEventEmitter).to receive(:emit).with(process.guid, "Updated app with guid #{process.guid} (#{expected_request_field})")
      ...
      describe '#record_app_create' do
        ...
        it 'logs the event' do
          expect(VCAP::AppEventEmitter).to receive(:emit).with(process.guid, "Created app with guid #{process.guid}")
      ...
      describe '#record_app_delete' do
        ...
        it 'logs the event' do
          expect(VCAP::AppEventEmitter).to receive(:emit).with(process.guid, "Deleted app with guid #{process.guid}")
      ...
      describe '#create_app_exit_event' do
        ...
        it 'logs the event' do
          expect(VCAP::AppEventEmitter).to receive(:emit).with(exiting_process.guid, "App instance exited with guid #{exiting_process.guid} payload: #{droplet_exited_payload}")
