  ...
  module Repositories
    class ProcessEventRepository
      ...
      def self.record_create(process, user_audit_info, manifest_triggered: false)
        VCAP::AppEventEmitter.emit(process.app.guid, "Added process: \"#{process.type}\"")
      ...
      def self.record_delete(process, user_audit_info)
        VCAP::AppEventEmitter.emit(process.app.guid, "Deleting process: \"#{process.type}\"")
      ...
      def self.record_update(process, user_audit_info, request, manifest_triggered: false)
        VCAP::AppEventEmitter.emit(process.app.guid, "Updating process: \"#{process.type}\"")
      ...
      def self.record_scale(process, user_audit_info, request, manifest_triggered: false)
        VCAP::AppEventEmitter.emit(process.app.guid, "Scaling process: \"#{process.type}\"")
      ...
      def self.record_terminate(process, user_audit_info, index)
        VCAP::AppEventEmitter.emit(process.app.guid, "Terminating process: \"#{process.type}\", index: \"#{index}\"")
      ...
      def self.record_crash(process, crash_payload)
        VCAP::AppEventEmitter.emit(process.app.guid, "Process has crashed with type: \"#{process.type}\"")
