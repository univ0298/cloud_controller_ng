  ...
  module Repositories
    class AppEventRepository
      ...
      def create_app_exit_event(app, droplet_exited_payload)
        VCAP::AppEventEmitter.emit(app.guid, "App instance exited with guid #{app.guid} payload: #{droplet_exited_payload}")
      ...
      def record_app_update(app, space, user_audit_info, request_attrs, manifest_triggered: false)
        ...
        VCAP::AppEventEmitter.emit(app.guid, "Updated app with guid #{app.guid} (#{audit_hash})")
      ...
      def record_app_apply_manifest(app, space, user_audit_info, manifest_request_yaml)
        VCAP::AppEventEmitter.emit(app.guid, "Applied manifest to app with guid #{app.guid} (#{manifest_request_yaml})")
      ...
      def record_app_create(app, space, user_audit_info, request_attrs)
        VCAP::AppEventEmitter.emit(app.guid, "Created app with guid #{app.guid}")
      ...
      def record_app_start(app, user_audit_info)
        VCAP::AppEventEmitter.emit(app.guid, "Starting app with guid #{app.guid}")
      ...
      def record_app_restart(app, user_audit_info)
        VCAP::AppEventEmitter.emit(app.guid, "Restarted app with guid #{app.guid}")
      ...
      def record_app_stop(app, user_audit_info)
        VCAP::AppEventEmitter.emit(app.guid, "Stopping app with guid #{app.guid}")
      ...
      def record_app_delete_request(app, space, user_audit_info, recursive=nil)
        VCAP::AppEventEmitter.emit(app.guid, "Deleted app with guid #{app.guid}")
